...
?>
<title>Ausleihe &Uuml;bersicht</title>
</head>
<body style="background-image: url(logo.jpg); background-repeat: no-repeat;">
<big><big><big>
Ausleihe Ger&auml;te&uuml;bersicht
</big></big></big>
<br>
<?php 
...
$ba=0;
if ((isset($_POST['ausg']))and (isset($_POST['ausl'])))
{
...
<form method="POST" action="Ausleihe-m2.php">
<input name="zur" type="submit" value="Auswahl wiederholen" class="Button-w"/>
</form>
<?php     
}
?>    
