...
?>
<title>Ausleihe verschiedenes</title>
</head>
<body style="background-image: url(logo.jpg); background-repeat: no-repeat;">
<big><big><big>
Ausleihe verschiedenes
</big></big></big>
<br>
<?php
...
if (isset($_POST['submit']))
{
    switch($_POST['submit'])
    {
        ...
        ?>
        <meta http-equiv="refresh" content="0; URL=Ausleihe-m3.php">
        <?php
        break;
...
{
    ?>
    <form action="Ausleihe-v1.php" method = "POST" align="center">
    ...
    <?php
    $sql = mysql_query("SELECT * FROM conf WHERE `wert`='aktiveseite'");            //aktive seite festlegen
    while($ds= mysql_fetch_object($sql))
    {
        $test=$ds->was;
    }
...
$sql1 = mysql_query("SELECT * FROM var WHERE `gida` > '0'");            //Tabelle var auswählen nur ausgewähltes Gerät gida>1 
while($ds1 = mysql_fetch_object($sql1))
    {
        $gida = $ds1->gida ;                                        //aus Datenbank var auslesen
    }
...
?>
<form method="POST" action="Ausleihe-v1.php">
